...
public final class TpaCommand {
    ...
    public static int execute(CommandContext<CommandSourceStack> context, AstradalTPAGui plugin) {
        ...
        try {
            ...
            plugin.getScrollManager().addPendingRequest(player, target, false);
            ...
            target.sendMessage(Component.text(player.getName(), NamedTextColor.GOLD)
                .append(Component.text(" wants to teleport to you using a TPA Scroll.", NamedTextColor.LIGHT_PURPLE)));
